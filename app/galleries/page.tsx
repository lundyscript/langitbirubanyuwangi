...
import { getGalleriesAllData, getGalleriesData, getGalleriesPages, getPostById, getPostsAllData, getPostsData, getPostsPages } from '@/data/posts'
          ...
          <div className="container px-4 md:px-6">
            ...
            :
              <BlurFade delay={0.25} inView className="space-y-4">
                <BentoForGalleryPage query={query} currentPage={currentPage}/>
      ...
      :
        ...
        <div className="container items-center max-w-4xl px-4 md:px-6 space-y-6">
          <div className="text-justify justify-center leading-loose space-y-3 z-50">
            <Link href={{pathname: '/galleries'}} className="text-sm font-medium text-muted-foreground transition-all duration-200 ease-out hover:text-primary hover:translate-x-1">← Back to All Articles</Link>
